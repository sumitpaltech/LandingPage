...
! function(t, e) {
        ...
        return r(m) ? w = x = {
            ...
            function(t, e, r) {
                ...
                if (!c) {
                    ...
                    "random" === m && db(c), c.max = h - l, c.min = l, c.v = d = (parseFloat(p.amount) || parseFloat(p.each) * (d < f ? d - 1 : b ? "y" === b ? d / f : f : Math.max(f, d / f)) || 0) * ("edges" === m ? -1 : 1), c.b = d < 0 ? g - d : g, c.u = Ya(p.amount || p.each) || 0, _ = _ && d < 0 ? Bt(_) : _
                }
    ...
    function Ob(t) {
        ...
        return r && 1 < e.length && r.config ? r.config.apply(null, ~t.indexOf("{") ? [function _parseObjectInString(t) {
            for (var e, r, i, n = {}, a = t.substr(1, t.length - 3).split(":"), s = a[0], o = 1, u = a.length; o < u; o++) r = a[o], e = o !== u - 1 ? r.lastIndexOf(",") : r.length, i = r.substr(0, e), n[s] = isNaN(i) ? i.replace(Yt, "").trim() : +i, s = r.substr(e + 1).trim();
            return n
    ...
    var F, L, l, I, h, n, a, i, o, f, d, c, p, _, m, g, b, k, O, M, C, A, z, E, D, Y, B, j, q = {
            autoSleep: 120,
            force3D: "auto",
            nullTargetWarn: 1,
            units: {
        ...
        Dt = /hsl[a]?\(/,
        Rt = (O = Date.now, M = 500, C = 33, A = O(), z = A, D = E = 1e3 / 240, g = {
            time: 0,
            frame: 0,
            tick: function tick() {
                yl(!0)
    ...
    function gn(t) {
        return t < j ? B * t * t : t < .7272727272727273 ? B * Math.pow(t - 1.5 / 2.75, 2) + .75 : t < .9090909090909092 ? B * (t -= 2.25 / 2.75) * t + .9375 : B * Math.pow(t - 2.625 / 2.75, 2) + .984375
    }
    ...
    }), Lt.Linear.easeNone = Lt.none = Lt.Linear.easeIn, Sb("Elastic", Ub("in"), Ub("out"), Ub()), B = 7.5625, j = 1 / 2.75, Sb("Bounce", function(t) {
        return 1 - gn(1 - t)
    ...
    var Nt, Gt, Wt = function _addPropTween(t, e, i, n, a, o, u, h, l, f) {
        ...
        Qt = function _initTween(t, e, r) {
            var i, n, a, s, o, u, h, l, f, d, c, p, _, m = t.vars,
                ...
                D = t.timeline;
            if (!D || O && g || (g = "none"), t._ease = jt(g, V.ease), t._yEase = k ? Bt(jt(!0 === k ? g : k, V.ease)) : 0, k && t._yoyo && !t._repeat && (k = t._yEase, t._yEase = t._ease, t._ease = k), t._from = !D && !!m.runBackwards, !D || O && !m.stagger) {
    ...
    function Ld() {
        ...
        if (this.tfm) {
            ...
            a.svg && (a.renderTransform(), i.setAttribute("data-svg-origin", this.svgo || "")), (t = Ye()) && t.isStart || n[cr] || (Kd(n), a.zOrigin && n[pr] && (n[pr] += " " + a.zOrigin + "px", a.zOrigin = 0, a.renderTransform()), a.uncache = 1)
        }
    }
    ...
    function Sd() {
        (function _windowExists() {
            ...
            style: {}
        }, Od("div"), cr = mr(cr), pr = cr + "Origin", Le.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", Be = !!mr("perspective"), Ye = ze.core.reverting, Fe = 1)
    }
    ...
    function Vd(e) {
        ...
        return r && (r.width || r.height) || i || (r = Td(e)), !r || r.width || r.x || r.y ? r : {
            x: +Ud(e, ["x", "cx", "x1"]) || 0,
            y: +Ud(e, ["y", "cy", "y1"]) || 0,
            width: 0,
            height: 0
    ...
    var Ee, De, Re, Fe, Le, Ie, Ye, Be, qe = Lt.Power0,
        Ve = Lt.Power1,
        Ue = Lt.Power2,
        Xe = Lt.Power3,
        Ne = Lt.Power4,

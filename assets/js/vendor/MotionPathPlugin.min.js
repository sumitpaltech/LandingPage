...
! function(t, e) {
    ...
    function convertToPath(t, e) {
        var n, r, a, o, i, s, l, h, u, g, f, p, c, d, m, v, y, x, w, P, b, M, R = t.tagName.toLowerCase(),
            L = .552284749831;
    ...
    function measureSegment(t, e, n) {
        ...
        var r, a, o, i, s, l, h, u, g, f, p, c, d, m, v, y, x, w = ~~t.resolution || 12,
            P = 1 / w,
        ...
        for (T.length = C.length = 0, a = e + 2; a < b; a += 6) {
            if (o = t[a + 4] - M, i = t[a + 2] - M, s = t[a] - M, u = t[a + 5] - R, g = t[a + 3] - R, f = t[a + 1] - R, l = h = p = c = 0, H(o) < .01 && H(u) < .01 && H(s) + H(f) < .01) 8 < t.length && (t.splice(a, 6), a -= 6, b -= 6);
                ...
                for (r = 1; r <= w; r++) l = h - (h = ((m = P * r) * m * o + 3 * (d = 1 - m) * (m * i + d * s)) * m), p = c - (c = (m * m * u + 3 * d * (m * g + d * f)) * m), (y = $(p * p + l * l)) < S && (S = y), N += y, T[L++] = N;
            M += o, R += u
        }
        if (_)
    ...
    function stringToRawPath(t) {
        ...
        for (e = 0; e < w; e++)
            if (p = o, isNaN(m[e]) ? i = (o = m[e].toUpperCase()) !== m[e] : e--, r = +m[e + 1], a = +m[e + 2], i && (r += y, a += x), e || (l = r, h = a), "M" === o) s && (s.length < 8 ? --v.length : P += s.length), y = l = r, x = h = a, s = [r, a], v.push(s), e += 2, o = "L";
            else if ("C" === o) i || (y = x = 0), (s = s || [0, 0]).push(r, a, y + 1 * m[e + 3], x + 1 * m[e + 4], y += 1 * m[e + 5], x += 1 * m[e + 6]), e += 6;
        else if ("S" === o) u = y, g = x, "C" !== p && "S" !== p || (u += y - s[s.length - 4], g += x - s[s.length - 3]), i || (y = x = 0), s.push(u, g, r, a, y += 1 * m[e + 3], x += 1 * m[e + 4]), e += 4;
            ...
            if (c = m[e + 4], d = m[e + 5], u = m[e + 6], g = m[e + 7], n = 7, 1 < c.length && (c.length < 3 ? (g = u, u = d, n--) : (g = d, u = c.substr(2), n -= 2), d = c.charAt(1), c = c.charAt(0)), f = arcToSegment(y, x, +m[e + 1], +m[e + 2], +m[e + 3], +c, +d, (i ? y : 0) + 1 * u, (i ? x : 0) + 1 * g), e += n, f)
    ...
    function aa(t, e) {
        ...
        if (u.length || u.push(Z(t, 1), Z(t, 2), Z(t, 3)), n = l ? b : f, l) h ? (o = -(a = function _getCTM(t) {
            ...
            return e
        }(r) : r.getItem(0).matrix : E).a * a.x + r.c * a.y, i = r.b * a.x + r.d * a.y) : (r = new Y, o = i = 0), e && "g" === t.tagName.toLowerCase() && (o = i = 0), (h ? l : g).appendChild(n), n.setAttribute("transform", "matrix(" + r.a + "," + r.b + "," + r.c + "," + r.d + "," + (r.e + o) + "," + (r.f + i) + ")");
        else {
            if (o = i = 0, D)
    ...
    var c, v, w, P, f, b, E, I, D, n, k = "transform",
        z = k + "Origin",
        G = [],
        q = [],
        ...
        a = {
            ...
            init: function init(t, e, n) {
                ...
                if (this.rawPaths = o, this.target = t, this.tween = n, this.styles = J && J(t, "transform"), (this.rotate = s || 0 === s) && (this.rOffset = parseFloat(s) || 0, this.radians = !!e.useRadians, this.rProp = e.rotation || "rotation", this.rSet = t._gsap.set(t, this.rProp, this), this.ru = Q(t._gsap.get(t, this.rProp)) || 0), !Array.isArray(i) || "closed" in i || "number" == typeof f) cacheRawPathMeasurements(r = p(nt(getRawPath(e.path), t, e)), e.resolution), o.push(r), rt(this, t, e.x || "x", r, "x", e.unitX || "px"), rt(this, t, e.y || "y", r, "y", e.unitY || "px");
                    ...
                    for (a in u && g ? o.push(qa(this, na(na([], i, u, 0), i, g, 1), t, u, g, p, e, l || Q(i[0][u]), h || Q(i[0][g]))) : u = g = 0, f) a !== u && a !== g && o.push(qa(this, na([], i, a, 2), t, a, 0, p, e, Q(i[0][a])))
                }
